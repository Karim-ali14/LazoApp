...
class ModelList {
  ...
  @override
  String toString() => 'ModelList[createdAt=$createdAt, id=$id, isSelectable=$isSelectable, name=$name, nameAr=$nameAr, nameEn=$nameEn, price=$price, productId=$productId, updatedAt=$updatedAt]';
