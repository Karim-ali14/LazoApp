...
class ReadANotification1200ResponseData {
  ...
  @override
  String toString() => 'ReadANotification1200ResponseData[createdAt=$createdAt, id=$id, image=$image, imagePath=$imagePath, isRead=$isRead, notification=$notification, notificationAr=$notificationAr, notificationEn=$notificationEn, provider=$provider, providerId=$providerId, title=$title, titleAr=$titleAr, titleEn=$titleEn, updatedAt=$updatedAt, user=$user, userId=$userId]';
