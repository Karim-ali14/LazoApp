...
class ProviderOrderDetailsDataOrderItemsInnerService {
  /// Returns a new [ProviderOrderDetailsDataOrderItemsInnerService] instance.
  ProviderOrderDetailsDataOrderItemsInnerService({
    this.cardExpiration,
    this.cardPrice,
    this.cardType,
    this.coverImagePath,
  ...
  List<ProviderOrderDetailsDataOrderItemsInnerServiceListsInner> lists;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProviderOrderDetailsDataOrderItemsInnerService &&
  ...
  /// Returns a new [ProviderOrderDetailsDataOrderItemsInnerService] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderOrderDetailsDataOrderItemsInnerService? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderOrderDetailsDataOrderItemsInnerService[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderOrderDetailsDataOrderItemsInnerService[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ProviderOrderDetailsDataOrderItemsInnerService(
        ...
        lists: ProviderOrderDetailsDataOrderItemsInnerServiceListsInner.listFromJson(json[r'lists']),
  ...
  static List<ProviderOrderDetailsDataOrderItemsInnerService> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderOrderDetailsDataOrderItemsInnerService>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderOrderDetailsDataOrderItemsInnerService.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderOrderDetailsDataOrderItemsInnerService> mapFromJson(dynamic json) {
    final map = <String, ProviderOrderDetailsDataOrderItemsInnerService>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderOrderDetailsDataOrderItemsInnerService.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderOrderDetailsDataOrderItemsInnerService-objects as value to a dart map
  static Map<String, List<ProviderOrderDetailsDataOrderItemsInnerService>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderOrderDetailsDataOrderItemsInnerService>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderOrderDetailsDataOrderItemsInnerService.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
