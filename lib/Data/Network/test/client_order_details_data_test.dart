...
// tests for ClientOrderDetailsData
void main() {
  // final instance = ClientOrderDetailsData();

  group('test ClientOrderDetailsData', () {
    ...
    // List<ClientOrderDetailsDataOrderItemsInner> orderItems (default value: const [])
