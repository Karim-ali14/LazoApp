...
// tests for ProviderOrderDetailsData
void main() {
  // final instance = ProviderOrderDetailsData();

  group('test ProviderOrderDetailsData', () {
    ...
    // List<ProviderOrderDetailsDataOrderItemsInner> orderItems (default value: const [])
