...
// tests for ShowOrderDetails2200ResponseDataOrderItemsInner
void main() {
  // final instance = ShowOrderDetails2200ResponseDataOrderItemsInner();

  group('test ShowOrderDetails2200ResponseDataOrderItemsInner', () {
    // num cardPrice
