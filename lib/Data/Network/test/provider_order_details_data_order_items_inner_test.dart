...
// tests for ProviderOrderDetailsDataOrderItemsInner
void main() {
  // final instance = ProviderOrderDetailsDataOrderItemsInner();

  group('test ProviderOrderDetailsDataOrderItemsInner', () {
    // num cardPrice
