...
// tests for ShowNotifications1200ResponseDataInnerUser
void main() {
  // final instance = ShowNotifications1200ResponseDataInnerUser();

  group('test ShowNotifications1200ResponseDataInnerUser', () {
    // num id
