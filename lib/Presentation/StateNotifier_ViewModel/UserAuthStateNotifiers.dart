...
import 'package:lazo_provider/Domain/UseCases/ProviderAuthUseCases.dart';
...
final providerTokenStateProvider = StateNotifierProvider.autoDispose<UserProvider,StateModel<StateModel>>((ref) => UserProvider(ref));
